...
public:
  ...
  void computeFeatures(Eigen::MatrixXd &scene_normal, std::vector<Eigen::Vector3d> &points, std::vector<float> &intensities);
  void computeFeatures_wt_Trick(Eigen::MatrixXd &scene_normal, std::vector<Eigen::Vector3d> &points, std::vector<float> &intensities, Cylinder *cyl_);
